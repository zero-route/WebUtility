    ...
    <div className="flex flex-col gap-4">
      <div>
        ...
        <button
          ...
          className="mt-3 flex w-full items-center justify-center gap-2 rounded-lg bg-teal px-4 py-2 text-sm font-medium text-black transition-colors hover:bg-teal-dark"
        >
          <RefreshCw size={14} />
          Generate
        </button>
